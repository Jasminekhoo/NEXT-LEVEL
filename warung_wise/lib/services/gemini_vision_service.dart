...
class GeminiVisionService {
  ...
  */
  ...
  // ✅ ADD THIS: Constructor to auto-run the debug check
  GeminiVisionService() {
    debugListModels();
  }
  ...
  /// Public API: accepts XFile (recommended) or File (legacy)
